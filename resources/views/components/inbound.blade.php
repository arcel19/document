                    ...
                    <table class="center-aligned-table table">
                        ...
                        <tbody>
                            @foreach ($document as $doc)
                                <tr class="">
                                    ...
                                    <td>
                                        @if ($doc->records->isNotEmpty())
                                            {{ $doc->records->first()->createdBy->name }}
                                        @else
                                            {{ auth()->user()->name }}
                                        @endif
                                    </td>
                                    ...
                                    <td><a href="#" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#deleteModal{{ $doc->id }}">Delete</a></td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label">List of
                                                        Files:</label>
                                                    @foreach ($doc->file->where('document_id', $doc->id) as $f)
                                                        ...
                                                        {{-- deleteModal --}}
                                                        <div class="modal fade" id="deleteModal{{ $doc->id }}"
                                                            tabindex="-1" aria-labelledby="deleteModal"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header text-center">
                                                                        <h1 class="modal-title fs-5" id="deleteModal">
                                                                            Are you sure you want to delete it ? </h1>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                            aria-label="Close"></button>
                                                                    </div>
                                                                    <form
                                                                        action="{{ route('document.destroy', $doc) }}"
                                                                        method="POSt">
                                                                        @method('delete')
                                                                        @csrf
                                ...
                                <!-- send Modal -->
                                <div class="modal fade" id="sendModal{{ $doc->id }}" tabindex="-1"
                                    aria-labelledby="sendModal" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('send', $doc->id) }}" method="POST"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    <select class="form-select" multiple
                                                        aria-label="Multiple select example" name="receiver[]">
                ...
                <form action="{{ route('document.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="file" name="path[]" id="formFileMultiple"
                                multiple>
                            @error('path')
                                <span class="text-danger"> {{ $message }}</span>
                            @enderror
